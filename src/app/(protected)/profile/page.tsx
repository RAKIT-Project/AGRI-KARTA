    ...
    <div className="flex flex-col gap-6 max-w-2xl mx-auto w-full">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Kelola informasi akun dan pengaturan WhatsApp Anda.
        </p>
      </div>
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          ...
          <CardDescription>
            Detail akun Anda yang terdaftar di sistem AGRI-KARTA.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4">
            ...
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Bergabung Sejak</span>
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          ...
          <CardDescription>
            Hubungkan nomor WhatsApp Anda untuk menerima notifikasi harga secara real-time.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* WhatsApp Verification Status */}
          <WhatsAppStatus isVerified={profile.is_wa_verified} />
          
          {/* Phone Number Form */}
          <ProfileForm currentPhoneNumber={profile.phone_number} />
        </CardContent>
      </Card>
    </div>
  );
